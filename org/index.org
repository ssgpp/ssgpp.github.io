...
+ ~yürüt~ /iş hattı/
  ...
  verilen /iş hattı/ çalıştırılır.

+ /iş hattı kısayolu/ 

  girilen iş hattı kısayolunu çalıştırır. (bkz: [[file:IsHattiKisayollari.org][iş hattı kısayolları]]) (bkz: [[file:YeniIsHattıKısayoluTanimlama.org][yeni iş hattı kısayolu tanımlama]])

+ ~mesaj~ 

  giriş yapmış kullanıcının mesajı olup olmadığını kontrol eder.
