...
|                | bir başlıktaki youtube bağlantıları:                                                                                                                                                                                                          |
|                | ~ssg++ yürüt başlıkknk [başlık=insanı mutlu eden şarkılar] ! başlıkgirdileri ! alanseçici [alan=disariBaglantilar] ! genelflt [alan=text, değer=http://www.youtube.com, benzerlik=sonuekli] ! dosyabtk [dosya=basligin-youtube-linkleri.txt]~ |

Parametreleri
| parametre | alabildiği değerler                                                                                                                                                                                      | açıklama                                                          | varsayılan değeri |
| <l>       | <l>                                                                                                                                                                                                      | <l>                                                               | <l>               |
|-----------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------------+-------------------|
| alan      | Girdi kapısındaki veri tipinin alanlarından biri. Örneğin, Girdi tipindeki veriler için alan şu değerleri alabilir: yazar, baslik, id, girdiSirasi, bkzBasliklari, gorunmezBkzBasliklari, disBaglantilar | Girdi kapısındaki verilerin hangi alanının seçileceğini belirler. | yazar             |
